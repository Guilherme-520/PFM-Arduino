...
const char* ssid = "Gui"; // Substitua pelo nome da sua rede Wi-Fi
const char* password = "guilindo"; // Substitua pela senha da sua rede Wi-Fi

// Endereço da API do backend
const char* serverUrl = "http://192.168.29.16:3031/add"; // Substitua pelo IP ou URL do backend
